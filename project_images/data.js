...
handleChange(e)
{
  ...
  render() {
      ...
      <Button variant="success" type="submit" onClick={()=>{this.props.action(this.state.answer)}}>Answer</Button></form>
      )
  }
}
...
class Data extends React.Component {
  ...
  this.state={ question_new:"", user:"", button_flag:true,ad:"", temp_id:"",
...
// Posting answers
async answerIt(id){
this.setState({button_flag:false});
...
let date = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
 ...
 { list.map(item => (
  ...
  {!this.state.button_flag&&(<Col md={6}><Child action={this.postAnswer} /></Col>)}
